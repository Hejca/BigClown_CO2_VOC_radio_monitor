...
#define TEMPERATURE_TAG_PUB_NO_CHANGE_INTEVAL (10 * 60 * 1000)
...
#define HUMIDITY_TAG_PUB_NO_CHANGE_INTEVAL (10 * 60 * 1000)
#define HUMIDITY_TAG_PUB_VALUE_CHANGE 5.0f
#define HUMIDITY_TAG_UPDATE_SERVICE_INTERVAL (5 * 1000)
#define HUMIDITY_TAG_UPDATE_NORMAL_INTERVAL (30 * 1000)
...
#define CO2_PUB_NO_CHANGE_INTERVAL (10 * 60 * 1000)
#define CO2_PUB_VALUE_CHANGE 50.0f
#define CO2_UPDATE_SERVICE_INTERVAL (1 * 60 * 1000)
#define CO2_UPDATE_NORMAL_INTERVAL  (5 * 60 * 1000)

#define VOC_TAG_PUB_NO_CHANGE_INTEVAL (10*60 * 1000)
#define VOC_TAG_PUB_VALUE_CHANGE 4.0f
#define VOC_TAG_UPDATE_SERVICE_INTERVAL (5 * 1000)
#define VOC_TAG_UPDATE_NORMAL_INTERVAL (30 * 1000)
...
void button_event_handler(bc_button_t *self, bc_button_event_t event, void *event_param)
{
    ...
    if (event == BC_BUTTON_EVENT_PRESS)
    {
        ...
        bc_radio_pub_string("voc-lp-sensor/0:0/Who_am_I","Button PUSH");
    }
